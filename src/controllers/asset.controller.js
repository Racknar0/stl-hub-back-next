...
async function generateSeoAllForAsset(assetInput, availableCategories, assetRaw = null) {
    ...
    const prompt = [
        ...
        'Regla especial de categorización: si el título o el nombre del asset contiene la palabra "flexi", "flexible", "articulado" o "articuled" (o derivados de articulado flexible), debes incluir la categoría con slug "articulados" obligatoriamente en tu selección de categorías sugeridas.',
