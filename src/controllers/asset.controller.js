...
async function generateSeoAllForAsset(assetInput, availableCategories, assetRaw = null) {
    ...
    const prompt = [
        ...
        'Regla especial de categorización: si el título o el nombre del asset contiene la palabra "flexi", "felxi", "flexible", "articulado" o "articuled" (o derivados de articulado flexible), debes incluir la categoría con slug "articulados" obligatoriamente en tu selección de categorías sugeridas.',
        'Regla especial de categorización: si el título o el nombre del asset contiene la palabra "keychain" o "llavero" (o derivados), debes incluir la categoría con slug "llavero" obligatoriamente en tu selección de categorías sugeridas.',
        'Regla especial de categorización: si el título o el nombre del asset contiene la palabra "maceta", "macetas", "planta", "plantas" (o derivados), o en inglés "planter", "planters", "pot", "pots", "plant", "plants", debes incluir la categoría con slug "macetas-y-jardn" obligatoriamente en tu selección de categorías sugeridas.',
        'Regla especial de categorización: si el título o el nombre del asset contiene la palabra "lithophane", "litophane", "lithopane", "litofania" (o derivados/variantes), debes incluir la categoría con slug "litofanias" obligatoriamente en tu selección de categorías sugeridas.',
        'Regla especial de categorización: si el título o el nombre del asset contiene la palabra "lampara", "lamparas", "lamp" (o derivados/variantes), debes incluir la categoría con slug "lamparas" obligatoriamente en tu selección de categorías sugeridas.',
        '',
